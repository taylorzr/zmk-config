...
build shield microcontroller drive:
	cd ../zmk/app && west build --pristine -d build_{{shield}} -b {{microcontroller}} -- -DSHIELD={{shield}} -DZMK_CONFIG="${HOME}/code/zmk-config/config"
...
# 	rm zephyr-sdk-{{version}}_linux-x86_64.tar.gz
